...
function ArtistCard({
  ...
  return (
    ...
    >
      ...
      {/* Content */}
      <div className="flex-1 flex flex-col" style={{ padding: '10px 12px 12px', marginTop: '-2px' }}>
        ...
        <div className="mt-auto flex items-center" style={{ gap: '8px', marginBottom: '8px' }}>
  ...
  return (
    <div className="min-h-screen" style={{ background: BG, fontFamily: 'system-ui, sans-serif' }}>
      ...
      <nav className="flex items-center gap-4 px-4 md:px-6 py-3 border-b sticky top-0 z-50"
        ...
        <a href="/" className="text-sm py-3 px-2 transition-colors hover:text-white" style={{ color: W50 }}>Pipeline</a>
        <a href="/discovery" className="text-sm py-3 px-2 font-medium" style={{ color: Y }}>Radar</a>
        <a href="/brand-search" className="text-sm py-3 px-2 transition-colors hover:text-white" style={{ color: W50 }}>Match</a>
      </nav>
